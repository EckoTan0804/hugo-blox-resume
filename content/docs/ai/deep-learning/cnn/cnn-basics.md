...
{{< figure src="https://raw.githubusercontent.com/EckoTan0804/upic-repo/master/uPic/0.gif" caption="The convolution filter/kernel has the same depth as the input image" numbered="true" >}}

Convolution using a single filter:

{{< figure src="https://raw.githubusercontent.com/EckoTan0804/upic-repo/master/uPic/3d-conv_1.png" caption="Convolution using a single filter" numbered="true" >}}
...
{{< figure src="https://raw.githubusercontent.com/EckoTan0804/upic-repo/master/uPic/1*BMngs93_rm2_BpJFH2mS0Q.gif" caption="Stride 2 convolution" numbered="true" >}}
...
{{< figure src="https://miro.medium.com/max/700/1*W2D564Gkad9lj3_6t9I2PA@2x.gif" caption="Height and width of feature map is same as the input image due to padding (the gray area)." numbered="true" >}}
...
{{< figure src="https://ujwlkarn.files.wordpress.com/2016/08/screen-shot-2016-08-07-at-6-11-53-pm.png?w=748" caption="This example shows the effect of Pooling on the Rectified Feature Map we received after the ReLU operation in the above ReLU example. Max refers to Max-Pooling and Sum refers to Sum-Pooling." numbered="true" >}}
